...
@interface IHRT_Fourth_ViewController ()

@property (nonatomic, assign) NSInteger level;

@end

@implementation IHRT_Fourth_ViewController
...
- (void)pri_enter {
    IHRT_Fourth_ViewController *vc = [IHRT_Fourth_ViewController new];
