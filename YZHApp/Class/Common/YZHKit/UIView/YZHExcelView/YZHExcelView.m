...
#import "YZHExcelView.h"
#import "YZHExcelContentView.h"
#import "YZHKitType.h"

@interface YZHExcelView ()<YZHExcelContentViewDelegate>

//上部lock的view
@property (nonatomic, strong) YZHExcelContentView *topExcelContentView;
//底部滚动的view
@property (nonatomic, strong) YZHExcelContentView *bottomExcelContentView;

@property (nonatomic, strong) YZHExcelContentViewModel *topContentViewModel;
@property (nonatomic, strong) YZHExcelContentViewModel *bottomContentViewModel;
...
{
    self.topExcelContentView = [[YZHExcelContentView alloc] init];
    self.topExcelContentView.delegate = self;
    [self addSubview:self.topExcelContentView];
    
    self.bottomExcelContentView = [[YZHExcelContentView alloc] init];
...
-(void)_updateRowCellSeparatorLineInfo:(YZHExcelContentViewModel*)viewModel
{
...
-(YZHExcelContentViewModel*)_createContentViewModel:(BOOL)isTop
{
    YZHExcelContentViewModel *viewModel = [[YZHExcelContentViewModel alloc] init];
...
-(YZHExcelContentViewModel*)topContentViewModel
{
...
-(YZHExcelContentViewModel*)bottomContentViewModel
{
...
-(BOOL)_doUpdateOtherExcelContentWithNow:(YZHExcelContentView*)now excelRowScrollInfo:(NSExcelRowScrollInfo*)scrollInfo
{
    YZHExcelContentView *update = nil;
...
#pragma mark YZHExcelContentViewDelegate
