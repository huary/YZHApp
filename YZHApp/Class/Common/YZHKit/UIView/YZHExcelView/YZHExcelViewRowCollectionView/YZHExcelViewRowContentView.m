 ...
 ****************************************************************************/
@interface YZHExcelViewRowContentView () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,YZHExcelItemCellDelegate>

@property (nonatomic, strong) YZHExcelViewRowCollectionViewLayout *flowLayout;

@end

@implementation YZHExcelViewRowContentView
...
-(YZHExcelViewRowCollectionViewLayout*)flowLayout
{
    if (_flowLayout == nil) {
        _flowLayout = [[YZHExcelViewRowCollectionViewLayout alloc] init];
...
{    
    ...
    [self.collectionView registerClass:[YZHExcelItemCell class] forCellWithReuseIdentifier:NSSTRING_FROM_CLASS(YZHExcelItemCell)];
}
...
{
    YZHExcelItemCell *excelCell = [collectionView dequeueReusableCellWithReuseIdentifier:NSSTRING_FROM_CLASS(YZHExcelItemCell) forIndexPath:indexPath];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSIndexPath *excelIndexPath = [self _excelIndexPathForCollectionCellIndexPath:indexPath];
    YZHExcelItemCell *excelCell = (YZHExcelItemCell*)[collectionView cellForItemAtIndexPath:indexPath];
...
#pragma mark YZHExcelItemCellDelegate
