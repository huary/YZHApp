...
@interface YZHCalendarTitleView ()
/*  */
@property (nonatomic, strong) YZHButton *prevBtn;

/* <#注释#> */
@property (nonatomic, strong) UILabel *titleLabel;

/* <#注释#> */
@property (nonatomic, strong) YZHButton *nextBtn;

/* <#注释#> */
@property (nonatomic, strong) YZHButton *rightBtn;

@end



@implementation YZHCalendarTitleView
...
//    self.backgroundColor = PURPLE_COLOR;
    ...
    CGFloat h = 12;
    CGFloat lineWidth = 2;
    UIImage *image = [YZHGraphicsContext createBackImageWithSize:CGSizeMake(w, h) lineWidth:lineWidth backgroundColor:nil strokeColor:RGB_WITH_INT_WITH_NO_ALPHA(0xdddddd)];
    self.prevBtn = [YZHButton buttonWithType:UIButtonTypeCustom];
    ...
    image = [YZHGraphicsContext createForwardImageWithSize:CGSizeMake(w, h) lineWidth:lineWidth backgroundColor:nil strokeColor:RGB_WITH_INT_WITH_NO_ALPHA(0xdddddd)];
    self.nextBtn = [YZHButton buttonWithType:UIButtonTypeCustom];
    ...
    self.titleLabel.font = SYS_FONT(12);
    ...
    w = 5;
    image = [YZHGraphicsContext createImageWithSize:CGSizeMake(w, w) cornerRadius:w/2 borderWidth:0 borderColor:nil backgroundColor:RGB_WITH_INT_WITH_NO_ALPHA(0x388CFF)];
    self.rightBtn = [YZHButton buttonWithType:UIButtonTypeCustom];
    self.rightBtn.layoutStyle = NSButtonLayoutStyleLR | NSButtonLayoutStyleCustomSpace;
    self.rightBtn.imageTitleSpace = 4;
    self.rightBtn.titleLabel.font = SYS_FONT(12);
...
-(void)setTitleModel:(YZHCalendarTitleModel *)titleModel
{
