...
//-----------------------------YZHPageScrollView-----------------------------
@interface YZHPageScrollView ()
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) YZHTitleButtonItem *lastSelectButtonItem;
...
@implementation YZHPageScrollView
...
-(void)_layoutSubPageViews
{
    ...
    for (i = 0; i < _numberOfPages; ++i) {
        ...
        YZHTitleButtonItem *btnItem = [YZHTitleButtonItem buttonItemWithTitle:title];
        btnItem.frame = frame;
...
-(UIFont*)_pageTitleNormalFont
{
    ...
    return SYS_FONT(defaultButtonTitleFontNM);
}
...
-(UIFont*)_pageTitleSelectedFont
{
    ...
    return SYS_FONT(defaultButtonTitleFontHL);
}
...
-(void)_scrollViewDidSelectPageWithoutDidSelectedEvent:(YZHTitleButtonItem*)selectBtnItem
{
...
-(void)_scrollViewDidSelectPage:(YZHTitleButtonItem*)selectBtnItem
{
    if (self.lastSelectButtonItem == selectBtnItem) {
        return;
    }
...
//    NSLog(@"sIndex=%ld,nIndex=%ld,R=%f,nR=%f",selectIndex,nextIndex,selectOffsetRatio,nextOffsetRatio);
    ...
    YZHTitleButtonItem *selectBtnItem = (YZHTitleButtonItem*)[self.scrollView viewWithTag:selectIndex+1];
    YZHTitleButtonItem *nextBtnItem = (YZHTitleButtonItem*)[self.scrollView viewWithTag:nextIndex + 1];
