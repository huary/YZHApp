...
#import "YZHProgressView+Default.h"
#import "YZHKitType.h"
#import "UIImage+YZHAdd.h"

static const CGFloat dismissTime_s = 1.0f;

@implementation YZHProgressView (Default)
...
static YZHProgressView *_toastView_s = nil;

@implementation YZHToast : NSObject

+ (YZHProgressView *)toastView
{
    if (_toastView_s == nil) {
        _toastView_s = [[YZHProgressView alloc] init];
